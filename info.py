...
PICS = (environ.get('PICS', 'https://envs.sh/8d3.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002043502363 -1002245813234') # give your force subscribe channel id here else leave it blank
